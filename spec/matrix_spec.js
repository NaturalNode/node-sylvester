...
describe('matrix', function() {
	...
	expect(svd.U).toEqual($M([[-0.5110308651281575, 0.21320071635561047, -0.7071067811884307, -0.43976460684002194],
	...
	expect(svd.S).toEqual($M([[5.85410196624969, 0, 0, 0],
			      [0, 2.999999999999999, 0, 0],
			      [0, 0, 1.0000000000000002, 0],
			      [0, 0, 0, 0.8541019662496846]]));

	expect(svd.V).toEqual($M([[-0.5110308651281587, 0.2132007163556105, 0.7071067811881557, 0.4397646068404634],
