...
describe('vector', () => {
  ...
  asDiagram('Vector.angleFrom').it(expectCall => {
    ...
    expectCall(new Vector([1, 1])).angleFrom(new Vector([-1, -0])).to.be.nan;
  ...
  asDiagram('Vector.log').it(expectCall => {
    ...
    expectCall(new Vector([2, 8]))
      .log(2)
      .to.vector.equal([1, 3]);
  });

  asDiagram('Vector.cross').it(expectCall => {
    expectCall(new Vector([2, 3, 4]))
      .cross([5, 6, 7])
  ...
  asDiagram('Vector.round').it(expectCall => {
    expectCall(new Vector([1.5, 2.6, 3.1]))
      .round()
      .to.vector.equal([2, 3, 3]);
  });

  asDiagram('Vector.snapTo').it(expectCall => {
    expectCall(new Vector([0.4000000000001, 0.5]))
      .snapTo(0.4)
      .to.vector.equal([0.4, 0.5]);
    expectCall(new Vector([-1, 0.25, 0.5, 0.75, 1]))
      .snapTo(0.3, 0.5)
